...
int main() {
    ...
    IVector* one = VectorImpl::createVector(3, data);
    ...
    cout << VectorImpl::equals(n, one, IVector::NORM::CHEBYSHEV, 0.001)<<" "<<VectorImpl::equals(n, two, IVector::NORM::CHEBYSHEV, 0.001) <<endl;
    n->applyFunction(foo);
    for(size_t i = 0; i < n->getDim(); i++) {
        double t;
        n->getCord(i, t);
